...
def tweet(tweets_list):
    for i in range(10000):
        ...
        command = "th sample.lua -checkpoint train_44000.t7 -length \"" + str(desired_tweet_length) + "\" -start_text \"" + b" ".join(selected_original_start).decode("ascii") + "\" -temperature 0.25 -gpu -1"
